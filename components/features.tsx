export default function Features() {
    return (
        <section>
            <div id="features" className="max-w-6xl mx-auto px-4 sm:px-6 scroll-smooth">
                <div className="py-12 md:py-20">
                    {/* Section header */}
                    <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
                        <h2 className="h2 mb-4">Overwhelmed by long Google Docs?</h2>
                    ...
                    >
                        ...
                        >
                            <svg className="w-16 h-16 mb-4" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
                                <rect className="fill-blue-500 text-purple-600" width="64" height="64" rx="32" />
                                <path
                            ...
                            <h4 className="h4 mb-2">Intuitive Navigation</h4>
                        ...
                        >
                            <svg className="w-16 h-16 mb-4" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
                                <circle className="fill-blue-500 text-purple-600" cx="32" cy="32" r="32" />
                                <path
                                    className="stroke-current text-purple-100"
                                    strokeWidth="2"
                                    strokeLinecap="square"
                            ...
                            <h4 className="h4 mb-2"> Google Docs Integration</h4>
                            <p className="text-lg text-gray-600 text-center">
                        ...
                        >
                            ...
                            <h4 className="h4 mb-2">Customizable Display</h4>
                            <p className="text-lg text-gray-600 text-center">
                                Filter and display specific heading levels to customise what you see in the navigation
                                panel.
                            </p>
                        </div>
                        ...
                        >
                            ...
                            <h4 className="h4 mb-2">Zoom Functionality</h4>
                            <p className="text-lg text-gray-600 text-center">
                        ...
                        >
                            ...
                            <h4 className="h4 mb-2">Dark theme</h4>
                            <p className="text-lg text-gray-600 text-center">
                                Switch to an eye-friendly dark theme for a comfortable editing experience, especially
